import { removePerson } from "./PeopleList";

// Simple display for all added people
            ...
            {people.peopleData.length > 0 ? people.peopleData.map((person, index) => (
                <div key={index} className="flex flex-row justify-center">
                    <div className="flex flex-row align-center">
                        <p className="mr-10 text-red-600 self-left cursor-pointer font-bold" onClick={e => removePerson(people, index)}>X</p>
